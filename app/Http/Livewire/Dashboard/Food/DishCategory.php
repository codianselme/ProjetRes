...
class DishCategory extends Component
{
    ...
    public function update()
    {
        ...
        try {
            $category = App\Models\DishCategory::findOrFail($this->categoryId);
            $category->update([
                'name' => $this->name,
                'description' => $this->description,
                'is_active' => $this->is_active
    ...
    public function render()
    {
        ...
        $categories = App\Models\DishCategory::where('name', 'like', $searchTerm)
            ->orWhere('description', 'like', $searchTerm)
            ->paginate(10);

        return view('livewire.dashboard.food.dish-category', [
