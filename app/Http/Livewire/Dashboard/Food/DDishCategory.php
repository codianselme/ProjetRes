...
class DDishCategory extends Component
{
    ...
    public function update()
    {
        ...
        try {
            $category = DishCategory::findOrFail($this->categoryId);
            $category->update([
                'name' => $this->name,
                'description' => $this->description,
                'is_active' => $this->is_active
    ...
    public function render()
    {
        ...
        $categories = DishCategory::where('name', 'like', $searchTerm)
            ->orWhere('description', 'like', $searchTerm)
            ->paginate(10);

        return view('livewire.dashboard.food.d-dish-category', [
